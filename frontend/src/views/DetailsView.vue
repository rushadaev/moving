    ...
    <main v-else-if="isEditing || !requestsStore.selectedRequest" class="p-5 pb-24">
      ...
      <form @submit.prevent="saveRequest">
        ...
        <div class="mb-4">
          ...
          <select v-model="formData.property_type" class="w-full p-2 border rounded text-black">
        ...
        <div class="mb-4">
          ...
          <input type="number" v-model="formData.square_feet" class="w-full p-2 border rounded text-black" />
        </div>

        <!-- Movers Count -->
        <div class="mb-4">
          <label class="block text-sm font-medium mb-1">Number of Movers</label>
          <input type="number" v-model="formData.movers_count" min="1" class="w-full p-2 border rounded text-black" />
        </div>

        <!-- Hourly Rate -->
        <div class="mb-4">
          <label class="block text-sm font-medium mb-1">Hourly Rate ($)</label>
          <input type="number" v-model="formData.hourly_rate" class="w-full p-2 border rounded text-black" />
        </div>

        <!-- Departure Time -->
        <div class="mb-4">
          <label class="block text-sm font-medium mb-1">Departure Time</label>
          <input type="datetime-local" v-model="formData.departure_time" class="w-full p-2 border rounded text-black" />
        </div>

        <!-- Loading Address -->
        <div class="mb-4">
          <label class="block text-sm font-medium mb-1">Loading Address</label>
          <input type="text" v-model="formData.addresses[0].address" class="w-full p-2 border rounded text-black" />
        </div>

        <!-- Unloading Address -->
        <div class="mb-4">
          <label class="block text-sm font-medium mb-1">Unloading Address</label>
          <input type="text" v-model="formData.addresses[1].address" class="w-full p-2 border rounded text-black" />
        </div>
